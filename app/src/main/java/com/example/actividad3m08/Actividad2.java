...
public class Actividad2 extends AppCompatActivity {
    ...
    /*public void cargarRecursoAudio (String nombreCancion){


        // Obtener el identificador del recurso en el directorio raw que coincida con el nombre pasado
        int recursoId = getResources().getIdentifier(nombreCancion, "raw", getPackageName());

        // Verifico si se encontró el recurso antes de crear el MediaPlayer
        if (recursoId != 0) {
           audio = MediaPlayer.create(this, recursoId);
